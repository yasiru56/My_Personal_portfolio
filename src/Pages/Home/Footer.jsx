  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/yasiru.induwara.94"
            ...
            <li>
              <a
                href="https://www.instagram.com/yasiru________/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/yasiru-induwara-942337337/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content"> © 2025 Yasiru Induwara</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
